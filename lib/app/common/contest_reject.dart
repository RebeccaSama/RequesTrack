...
class ContestReject extends StatefulWidget {
  final dynamic snapshot;
  const ContestReject({Key? key, this.snapshot}) : super(key: key);

  @override
  State<ContestReject> createState() => _ContestRejectState();
}

class _ContestRejectState extends State<ContestReject> {
  bool expanded = false;
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                const Padding(
                                  padding:
                                      EdgeInsets.only(bottom: 0xffEB433516),
                                  child: Divider(
                                    color: Color(0xffEB4335),
                                    thickness: 1.2,
                                    height: 0,
                                ...
                                Container(
                                  ...
                                  child: Column(children: [
                                    ...
                                    Mark(
                                        title: "Réception rejetée le",
                                        subtitle: widget.snapshot["reject"]
                                            ["reject_date"],
