...
class SlidingSheet extends StatefulWidget {
  ...
  /// Allows you to supply your own custom scroll view. Useful for infinite lists
  ...
  /// behavior of sheets to go from rounded corners to sharp corners when
  ...
  /// {@template sliding_sheet.isBackDropInteractive}
  /// If true, the backDrop will also be Interactive so any gesture
  /// that is applied to the backDrop will be delegated to the sheet
  /// itself.
  /// {@endtemplate}
  final bool isBackdropInteractive;
  ...
  /// {@template sliding_sheet.isDismissible}
  /// If false, the `SlidingSheetDialog` will not be dismissible.
  ///
  ...
  SlidingSheet({
    ...
    bool isBackdropInteractive = false,
    Widget? body,
    ...
    double liftOnScrollFooterElevation = 0.0,
          ...
          isBackdropInteractive: isBackdropInteractive,
          body: body,
          parallaxSpec: parallaxSpec,
  ...
  SlidingSheet._({
    ...
    required this.isBackdropInteractive,
...
class _SlidingSheetState extends State<SlidingSheet>
  ...
  final ValueNotifier<SheetState> stateNotifier =
      ValueNotifier(SheetState.initial());
  ...
  Widget build(BuildContext context) {
    Widget result = LayoutBuilder(
      builder: (context, constraints) {
        ...
        availableHeight = constraints.biggest.height;
  ...
  Widget _buildScrollView() {
    Widget scrollView = Listener(
      onPointerUp: (_) => _handleNonDismissibleSnapBack(),
      child: () {
  ...
  Widget _buildBackdrop() {
    return ValueListenableBuilder(
      ...
      builder: (context, dynamic value, child) {
        ...
        void onTap() => widget.isDismissible
            ? _pop(0.0)
        ...
        if (opacity >= 0.05 || didStartDragWhenNotCollapsed) {
          if (widget.isBackdropInteractive) {
...
class SheetState {
  ...
  /// A default constructor which can be used to initial `ValueNotifiers` for instance.
  SheetState.initial()
      : this(null,
